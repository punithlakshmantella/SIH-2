    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-center items-center p-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-center z-10">
        ...
        <div className="md:col-span-6 space-y-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <span className="text-xs text-cyan-600 font-mono">SIH26127 • Bharat Electronics Limited</span>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-2 pt-1">
              {quickRoles.map((r, i) => (
                <button
                  ...
                  className="p-2 rounded-lg bg-slate-50/80 hover:bg-slate-100/90 border border-slate-200 text-left transition flex flex-col justify-between group"
                >
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-bold text-slate-800 group-hover:text-cyan-600 transition truncate">
                      {r.role}
                    </span>
                  </div>
        ...
        <div className="md:col-span-6">
          <div className="p-8 rounded-2xl bg-white/90 border border-slate-200 shadow-2xl backdrop-blur-xl space-y-6">
            <div>
              <h3 className="text-lg font-bold text-slate-900">Sign in to Command Center</h3>
              <p className="text-xs text-slate-500 mt-1">Authenticate with your department credentials</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-1.5">Username or Email</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50/80 border border-slate-200 rounded-xl pl-9 pr-4 py-2.5 text-xs text-slate-900 placeholder:text-slate-600 focus:outline-none focus:border-cyan-500 transition"
                    required
                  />
                </div>
              </div>
