...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6 space-y-4">
      ...
      <div>
        <h1 className="text-xl font-bold text-slate-100">404 — Page Not Found</h1>
        <p className="text-xs text-slate-400 mt-1">The requested operational route does not exist in City Vision.</p>
      </div>
      <Link
        to="/dashboard"
